...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const promptEmbed = new RichEmbed
            .setColor("GREEN")
            .setAuthor(":pick: :airplane: This verification becomes invalid after 30s :airplane: :pick:")
        ...
        message.channel.send(promptEmbed).then(async msg => {
            ...
            if (emoji === "✅") {
                ...
                toKick.kick(args.slice(1).join(" "))
                    .catch(err => {
                        if (err) return message.channel.send(`:pick: :airplane: Err....... Someting wen't wrong?`)
                    });
            ...
            message.reply(":pick: :airplane: Kick canceled... :airplane: :pick:")
                .then(m => m.delete(5000));
        }
        })
    }
